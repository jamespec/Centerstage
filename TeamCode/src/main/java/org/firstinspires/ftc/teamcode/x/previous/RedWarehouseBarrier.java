...
@Autonomous(name="RedWarehouseBarrier")
@Disabled
public class RedWarehouseBarrier extends LinearOpMode {
...
private static final String VUFORIA_KEY =
    ...
    public void runOpMode() {
        ...
        //first step
        twoMotorChassis.move( 0.0, 1125, 0.2, 1.0);
        ...
        // Turn right
        twoMotorChassis.turn(179, 2.5);
        //move( 135, 375, 0.2, 1.0 );
        elevator.setPower(0.1);

        // Drive into warehouse
        twoMotorChassis.move( 179, 2600, 0.3, 1.0);
