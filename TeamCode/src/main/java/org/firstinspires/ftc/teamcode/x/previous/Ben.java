...
public class Ben extends OpMode
{
    ...
    public void loop() {
        ...
        // David you labelled drive and turn backwards >:( - Joe
        double x = gamepad1.left_stick_x;
        
        double y = gamepad1.left_stick_y;
        
        double drive =  Range.clip(-Math.signum(x)*(Math.pow(x, 2.0)*(0.4)), -0.4, 0.4);
        
        double turn  =  Range.clip(-Math.signum(y)*(Math.pow(y, 2.0)*(0.55)), -0.55, 0.55);
        
        double elevatorSpeed =  Range.clip(gamepad2.left_stick_y, -1.0, 1.0);
        ...
        telemetry.addData("Elevator", "elevPower (%.2f)", elevatorSpeed);
        telemetry.addData("Rise", "risePower (%.2f)", risePower);
        ...
        //telemetry.addData("straightPower", "(%.2f)", straightPower);
