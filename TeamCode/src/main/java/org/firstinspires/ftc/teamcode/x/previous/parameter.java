...
@Autonomous(name="parameter")

public class parameter extends LinearOpMode 
{
...
// 2 6.5
    private static float[] leftPos = {5.7f/8f,4.25f/8f};
    ...
    public void runOpMode() 
    {
       ...
       //grab cone
        ...
        if (location == 1) {
            move( -90, 0, 0.2, 0.375 );
            move( -90, 1150, 0.3, 0.375 );
            //move( 0, 0, 0.3 );
        } else if (location == 3) {
            move( 90, 0, 0.3, 0.375 );
            move( 90, 1075, 0.3, 0.375);
            //move( 0, 0, 0.3 );
        } else if (location == 2);
    ...
    private void move( double targetAngle, int target, double power, double MAX_ERROR )
    {
        double P = 0.000035;
        double I = 0.000004;  // 0.000001;
        double sumError = 0;
        double error;
        Orientation angles;

        turn( targetAngle, MAX_ERROR );
        ...
        while(rightDrive.isBusy() )  // && rightDrive.isBusy()) 
        {
            ...
            telemetry.addData("Max_Error", "%f", MAX_ERROR);
            telemetry.update();
        }
    ...
    private void turn(double targetAngle, double MAX_ERROR)
    {
        double P = 0.0005;
        double I = 0.000045;
