...
private static final String VUFORIA_KEY =
    ...
    public void runOpMode() {
        ...
        //first step
        twoMotorChassis.move( 0.0, -900, 0.2, 1.0);
        ...
        // Backup            
        twoMotorChassis.move( -90, -850, 0.2, 1.0 );
        elevator.setPower(0.2);

        // Turn right
        twoMotorChassis.turn(135, 2.5);
        //move( 135, 375, 0.2, 1.0 );
        elevator.setPower(0.1);

        // Drive into warehouse
        twoMotorChassis.move( 135, 2600, 0.5, 15.0 );
